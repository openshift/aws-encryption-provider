...
ARG BUILDER=public.ecr.aws/eks-distro-build-tooling/golang:1.26.5-gcc
ARG BASE_IMAGE=public.ecr.aws/eks-distro-build-tooling/go-runner:v0.18.0-go-1.26.5.2023
